...
ax_n = plt.axes( [0.25, 0.2, 0.1, 0.3])
...
for i in range(len(pol[:,0])):
    drawEllipse(pol[i,0],pol[i,1], pol[i,2], pol[i,3], 0.01, ax_n)

ax_p = plt.axes([0.25, 0.6, 0.1, 0.3])
...
for i in range(len(pol[:,0])):
    drawEllipse(pol[i,0],pol[i,1], pol[i,2], pol[i,3], 0.01, ax_p)
