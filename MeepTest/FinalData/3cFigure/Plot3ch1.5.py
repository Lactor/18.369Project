...
hf_p = load('3c_pos_freq2.out', True) # TM Modes
hfi_p= load('3c_pos_freq2I.out', True) # TM Modes
...
pol = np.loadtxt('3c_pol.out', delimiter =' ',  dtype=complex)
...
for i in range(len(pol[:,0])):
    drawEllipse(pol[i,0],pol[i,1], pol[i,2], pol[i,3], 0.003, ax)
...
for i in range(len(pol[:,0])):
    drawEllipse(pol[i,0],pol[i,1], pol[i,2], pol[i,3], 0.003, ax_n)
...
for i in range(len(pol[:,0])):
    drawEllipse(pol[i,0],pol[i,1], pol[i,2], pol[i,3], 0.003, ax_p)
